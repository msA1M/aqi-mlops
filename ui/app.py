...
# =======================
    ...
    if drift_type == "AQI (Brasilia)":
        try:
            ...
            if len(brasilia_df) < 400:
                st.warning("Insufficient data for drift analysis. Need at least 400 records.")
            else:
        ...
        try:
            ...
            if len(city_df) < 400:
                st.warning(f"Insufficient data for {city}. Need at least 400 records.")
            else:
